 ...
 */
public class AzkarTasabeehAdapter extends RecyclerView.Adapter<AzkarTasabeehAdapter.ViewHolder>{
    ...
    @NonNull
    @Override
    public AzkarTasabeehAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType){
        Context context=parent.getContext();
        LayoutInflater inflater=LayoutInflater.from(context);
        View view=inflater.inflate(R.layout.azkar_item,parent,false);
        return new AzkarTasabeehAdapter.ViewHolder(view);
    }
     ...
     */
    @Override
    public void onBindViewHolder(@NonNull AzkarTasabeehAdapter.ViewHolder holder, int position){
